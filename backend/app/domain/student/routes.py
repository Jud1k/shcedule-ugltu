...
async def get_student_by_id(student_id: int, service: StudentServiceDep):
...
async def create_student(student_in: StudentCreate, service: StudentServiceDep):
    return await service.create(student_in=student_in)


@router.put("/{student_id}", response_model=StudentRead)
async def update_student(student_id: int, student_in: StudentUpdate, service: StudentServiceDep):
